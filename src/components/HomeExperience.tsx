...
const services = [
  { id: 'software', name: 'Software entwickeln.', text: 'Wenn Ihr Unternehmen eigene Wege geht, sollte Ihre Software das auch können. Wir entwickeln tabletoptimierte Angebotslösungen, interne Tools und Kundenportale, die sich an Ihrer Arbeit orientieren.', examples: ['Angebots- und Auftragssoftware', 'Interne Tools & Dashboards', 'Kundenportale'] },
  { id: 'automatisierung', name: 'Abläufe automatisieren.', text: 'Rechnungen ablegen, Dokumente auswerten, Projekte anlegen oder Newsletter versenden: Wir nehmen wiederkehrende Arbeit aus Ihrem Alltag. Mit KI dort, wo sie sinnvoll unterstützt.', examples: ['Rechnungs- und Dokumentenverarbeitung', 'Projekt- und Angebotsprozesse', 'Berichte & Auswertungen'] },
  { id: 'integration', name: 'Systeme verbinden.', text: 'Ihre Werkzeuge können mehr, wenn sie zusammenspielen. Wir verbinden ERP-, CRM-, E-Commerce- und Versandlösungen, damit Informationen dort ankommen, wo sie gebraucht werden.', examples: ['Shop & Warenwirtschaft', 'CRM, Buchhaltung & Versand', 'REST-APIs & Webhooks'] },
];
...
export function AboutAndApproach() {
  return <>
    <section className="po-section po-wrap" id="uber-uns"><SectionLabel number="03">Ihr Ansprechpartner</SectionLabel><div className="po-about-grid"><div><h2>Unternehmerisch<br />gedacht.<br /><span className="po-blue">Persönlich umgesetzt.</span></h2><p className="po-about-lead">Gute Software beginnt mit einem Gespräch über Ihre Arbeit.</p></div><div className="po-founder"><p className="po-founder-name">Dominique Deutzmann</p><span className="po-founder-role">Inhaber · Prozess-Orchester · Krefeld</span><p>Ich verbinde langjährige Erfahrung in Logistik, E-Commerce und Prozessmanagement mit eigener technischer Umsetzung. Seit vielen Jahren entwickle ich digitale Lösungen für operative Abläufe und betreibe selbst einen spezialisierten Online-Marktplatz.</p><p>Ob Angebotssoftware, Versandplanung, Rechnungsverarbeitung oder Schnittstellen: Wir schauen zuerst auf Ihre Arbeit, dann auf die passende Lösung. So entstehen Anwendungen und Automatisierungen, die im Alltag wirklich genutzt werden.</p><a className="po-inline-link" href="#contact-form">Lernen wir uns kennen <ArrowUpRight size={19} /></a></div></div></section>
