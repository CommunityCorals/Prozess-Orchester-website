...
export function ContactSection() {
  ...
  return <section className="po-contact-section" id="contact-form"><div className="po-wrap po-section"><div className="po-section-label"><span>06</span><span>Der erste Schritt</span><i aria-hidden="true" /></div><div className="po-contact-grid"><div><h2>Was soll bei Ihnen<br /><span>besser laufen?</span></h2><p>Erzählen Sie uns von Ihrer Idee oder einem Ablauf, der Sie Zeit kostet. Im unverbindlichen Erstgespräch finden wir heraus, wo wir ansetzen können.</p><a className="po-contact-mail" href="mailto:info@prozess-orchester.de">info@prozess-orchester.de <ArrowUpRight size={22} /></a><a className="po-contact-phone" href="tel:+4917645691439">+49 176 45691 439</a><div className="po-contact-note"><span>Persönlich. Verständlich. Auf Augenhöhe.</span><ArrowRight size={20} /></div></div><form className="po-contact-form" onSubmit={submit} aria-label="Projektanfrage">
    <div className="po-form-heading"><h3>Ihr Projekt beginnt hier.</h3><p>Ein paar Sätze reichen für den Anfang.</p></div>
